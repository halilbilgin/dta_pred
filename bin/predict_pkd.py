...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_file", type=str, help="Name of the CSV file")

    parser.add_argument("--input_file", type=str, help="Name of the CSV file")

    parser.add_argument("--arguments", type=str, help="Arguments to train the model")
    parser.add_argument(
        "--model_file",
        type=str,
    ...
    data = DataSet(
        ...
        args.protein_format,
        args.drug_format,
        args.mol2vec_model_path,
        args.mol2vec_radius,
        args.biovec_model_path,
    )
