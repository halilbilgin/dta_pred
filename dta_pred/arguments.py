...
def argparser():
    ...
    parser.add_argument("--smi_window_length", type=int, help="smiles filter length")
    parser.add_argument("--seq_window_length", type=int, help="motif filter length")
    parser.add_argument(
        "--n_cnn_layers", type=int, default=3, help="Number of CNN layers"
    )

    parser.add_argument("--num_windows", type=int, help="Number of filters in CNNs")
    parser.add_argument(
        "--n_fc_neurons",
        type=int,
        default=1024,
    ...
    parser.add_argument(
        "--max_seq_len", type=int, default=None, help="Length of input sequences."
    )
    parser.add_argument(
        "--max_smi_len", type=int, default=None, help="Length of input sequences."
    )
    parser.add_argument(
        "--protein_format",
        type=str,
    ...
    parser.add_argument("--dropout", type=float, default=0.4, help="Dropout level.")
    parser.add_argument(
        "--cross_validation", type=bool, default=False, help="Dropout level."
    )
    ...
    parser.add_argument(
        "--output_path", type=str, default="output/", help="Path to use for output."
    )
    parser.add_argument(
        "--mongodb", type=str, default=None, help="MongoDB configuration"
    )
    parser.add_argument(
        "--seed", type=int, default=42, help="Seed for ensuring reproducibility"
    )
    parser.add_argument(
        "--drug_format",
        type=str,
